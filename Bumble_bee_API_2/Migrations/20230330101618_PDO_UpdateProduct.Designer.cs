...
namespace Bumble_bee_API_2.Migrations
{
    ...
    [Migration("20230330101618_PDO_UpdateProduct")]
    partial class PDO_UpdateProduct
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Bumble_bee_API_2.Database.tbl_UserProduct", b =>
                {
                    ...
                    b.HasKey("UPDATE_USER", "PRODUCT_ID");

                    b.HasIndex("PRODUCT_ID");

                    b.ToTable("tbl_UserProducts");
                });

            modelBuilder.Entity("Bumble_bee_API_2.Database.tbl_Address", b =>
                {
                    b.HasOne("Bumble_bee_API_2.Database.tbl_City", "CITY")
                        .WithMany("ADDRESS")
                        .HasForeignKey("CITYCT_ID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Bumble_bee_API_2.Database.tbl_User", "USER")
                        .WithMany("ADDRESS")
            ...
            modelBuilder.Entity("Bumble_bee_API_2.Database.tbl_City", b =>
                {
                    b.HasOne("Bumble_bee_API_2.Database.tbl_District", "DISTRICT")
                        .WithMany("CITY")
            ...
            modelBuilder.Entity("Bumble_bee_API_2.Database.tbl_Product", b =>
                {
                    b.HasOne("Bumble_bee_API_2.Database.tbl_Brand", "BRAND")
                        .WithMany("PRODUCT")
                        .HasForeignKey("BRANDBR_ID");

                    b.HasOne("Bumble_bee_API_2.Database.tbl_Category", "CATEGORY")
                        .WithMany("PRODUCTS")
